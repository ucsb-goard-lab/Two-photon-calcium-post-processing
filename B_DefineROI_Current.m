function [] = B_DefineROI_Current(filelist)
...
% Updated 26Jan2022 KS to a new version compatible with 2018b+, uses a new
% class based GUI
...
irg = InteractiveROIGUI(template_filename); % new version 24Jan2022 KS
waitfor(irg.gui.fig);
template_filename = irg.getFilename();
